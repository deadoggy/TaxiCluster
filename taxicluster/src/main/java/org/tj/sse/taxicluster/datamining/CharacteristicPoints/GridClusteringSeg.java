...
//				}
	...
	/*	GetData gt = new GetData();
		...
		//�������ݿ�
		 ...
		 String cluster_type="grid";//���෽������DBSCAN,Grid,�ȵ�
		 gt.DbStoreHelper();
		  gt.AddIntoCluster(grid_cluster,cluster_type,cp_type);//���������ĵ����cluster_result
	      gt.AddCluster_rawPoint(grid_cluster,cluster_type,cp_type);//��raw point����cluster_raw
    ...
    public ArrayList<SegClustering> getClusterResult(){
    	...
    	for(int i=0;i<cList.size();i++){
    		List<Line> temp = new ArrayList<Line>();//ÿ�������Ӧһ���㼯
    		all.add(temp);
